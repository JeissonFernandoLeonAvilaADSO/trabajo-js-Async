...
¿Cuándo se ejecutará la función programada y por qué se ejecutará?
  ...
  R/ a) Después del bucle.

b) Antes del bucle.
c) Al comienzo del bucle.

  ¿Qué va a mostrar alert()?
    R/ las funciones de temporización que permiten programar la ejecución de código en un momento futuro,
    sin embargo, debido a que JavaScript es un lenguaje de programación de un solo hilo, estas funciones no garantizan que el código se ejecute exactamente después del tiempo especificado,
